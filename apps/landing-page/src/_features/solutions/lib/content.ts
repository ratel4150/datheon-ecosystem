...
export const content: Record<Lang, SolutionsContent> = {
  es: {
    ...
    colorLegendTitle: 'Colores por categoría',
    dragHint: 'Puedes arrastrar los bloques para reorganizar el diagrama.',
    copySummaryLabel: 'Copiar resumen técnico',
    copiedLabel: '¡Copiado!',
    viewDiagramLabel: 'Diagrama',
    viewTreeLabel: 'Árbol',
  ...
  en: {
    ...
    colorLegendTitle: 'Colors by category',
    dragHint: 'You can drag the blocks to rearrange the diagram.',
    copySummaryLabel: 'Copy technical summary',
    copiedLabel: 'Copied!',
    viewDiagramLabel: 'Diagram',
    viewTreeLabel: 'Tree',
  ...
  fr: {
    ...
    colorLegendTitle: 'Couleurs par catégorie',
    dragHint: 'Vous pouvez faire glisser les blocs pour réorganiser le diagramme.',
    copySummaryLabel: 'Copier le résumé technique',
    copiedLabel: 'Copié !',
    viewDiagramLabel: 'Diagramme',
    viewTreeLabel: 'Arbre',
