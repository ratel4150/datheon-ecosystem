// _widgets/cookie-consent/model/useCookieConsent.ts
'use client';

import { useCallback, useEffect, useState } from 'react';
import { getStoredConsent, setStoredConsent, CONSENT_REOPEN_EVENT, CONSENT_UPDATED_EVENT, type ConsentChoices } from '@/_shared/lib/cookie-consent';
