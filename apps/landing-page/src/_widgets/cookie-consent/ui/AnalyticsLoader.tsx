...
import { getStoredConsent, CONSENT_UPDATED_EVENT, type ConsentChoices } from '@/_shared/lib/cookie-consent';
import { ANALYTICS_IDS, loadGA4, loadGoogleAds, loadMetaPixel, loadClarity } from '@/_shared/lib/analytics';
